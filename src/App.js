					...
					<Routes>
						...
						>
							...
							<Route
								path="/profile"
								element={
									<UserProfile userInfo={userState} userState={userState} itIsMe={true} />
								}
							/>
							...
							<Route
								...
								element={
									<UserProfile userInfo={userState} userState={userState} setUserState={setUserState} />
								}
							/>
							...
							<Route
								path="/user/:userId"
								element={
									<UserDetails userState={userState} setUserState={setUserState} />
								}
							/>
